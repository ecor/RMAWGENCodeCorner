...
rdaname <-  'data/results_uncoupled_temperature_generator_P06.rda' #'/Users/ecor/R-packages/RMAWGENCodeCorner/data/results_uncoupled_temperature_generator_P06.rda' 
...
if (spatialCorrelation) {
	...
	png <- paste(wpath,'RMAWGENplotAplha_plot/spatial_correlation_tmin_uncoupled.png',sep='/')
	...
	png <- paste(wpath,'RMAWGENplotAplha_plot/spatial_correlation_tmax_uncoupled.png',sep='/')
	...
	png <- paste(wpath,'RMAWGENplotAplha_plot/spatial_correlation_tmin_uncoupled_unseas.png',sep='/')
	...
	png <- paste(wpath,'RMAWGENplotAplha_plot/spatial_correlation_tmax_uncoupled_unseas.png',sep='/')
...
if (qqplot) {
	for (it in stations) { 
		...
		png <- paste(wpath,'RMAWGENplotAplha_plot/qqplot_tmin_uncoupled_XXX.png',sep='/')  
		...
		png <- paste(wpath,'RMAWGENplotAplha_plot/qqplot_tmax_uncoupled_XXX.png',sep='/')  
		...
		png <- paste(wpath,'RMAWGENplotAplha_plot/qqplot_tmin_uncoupled_XXX_unseas.png',sep='/')  
		title <- "Quantile-Quantile daily minimum temperature at XXX"		
		...
		png <- paste(wpath,'RMAWGENplotAplha_plot/qqplot_tmax_uncoupled_XXX_unseas.png',sep='/')  
		title <- "Quantile-Quantile daily maximum temperature at XXX"		
...
for (l in lags) { 
	...
	png <- paste(wpath,'RMAWGENplotAplha_plot/spatial_XXX-lag_autocorrelation_tmin_uncoupled.png',sep='/')
	...
	png <- paste(wpath,'RMAWGENplotAplha_plot/spatial_XXX-lag_autocorrelation_tmax_uncoupled.png',sep='/')
	...
	# TMIN 
	title <- "XXX-lag spatial Autocorrelation: daily minimum temperature anom."
	png <- paste(wpath,'RMAWGENplotAplha_plot/spatial_XXX-lag_autocorrelation_tmin_uncoupled_unseas.png',sep='/')
	...
	title <- "XXX-lag spatial Autocorrelation: daily maximum temperature anom."
	png <- paste(wpath,'RMAWGENplotAplha_plot/spatial_XXX-lag_autocorrelation_tmax_uncoupled_unseas.png',sep='/')
...
png <- paste(wpath,'RMAWGENplotAplha_plot/spatial_autocrosscorrelation_tmax_uncoupled_lags.png',sep='/')
...
png <- paste(wpath,'RMAWGENplotAplha_plot/spatial_autocrosscorrelation_tmin_uncoupled_lags.png',sep='/')
