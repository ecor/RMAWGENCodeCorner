...
if (spatialCorrelation) {
	...
	png <- paste(wpath,'RMAWGENplotAplha_plot/spatial_correlation_tmin_coupled.png',sep='/')
	...
	png <- paste(wpath,'RMAWGENplotAplha_plot/spatial_correlation_tmax_coupled.png',sep='/')
	...
	png <- paste(wpath,'RMAWGENplotAplha_plot/spatial_correlation_tmin_coupled_unseas.png',sep='/')
	...
	png <- paste(wpath,'RMAWGENplotAplha_plot/spatial_correlation_tmax_coupled_unseas.png',sep='/')
...
## Check the correcteness of the station!! 
qqplot=TRUE ## TRUE
if (qqplot) {
	for (it in stations) { 
	
		png <- paste(wpath,'RMAWGENplotAplha_plot/qqplot_tmin_coupled_XXX.png',sep='/')  
		...
		png <- paste(wpath,'RMAWGENplotAplha_plot/qqplot_tmax_coupled_XXX.png',sep='/')  
		...
		png <- paste(wpath,'RMAWGENplotAplha_plot/qqplot_tmin_coupled_XXX_unseas.png',sep='/')  
		title <- "Quantile-Quantile daily minimum temperature at XXX"		
		...
		png <- paste(wpath,'RMAWGENplotAplha_plot/qqplot_tmax_coupled_XXX_unseas.png',sep='/')  
		title <- "Quantile-Quantile daily maximum temperature at XXX"		
...
for (l in lags) { 
	...
	png <- paste(wpath,'RMAWGENplotAplha_plot/spatial_XXX-lag_autocorrelation_tmin_coupled.png',sep='/')
	...
	png <- paste(wpath,'RMAWGENplotAplha_plot/spatial_XXX-lag_autocorrelation_tmax_coupled.png',sep='/')
	...
	# TMIN 
	title <- "XXX-lag spatial Autocorrelation: daily minimum temperature anom."
	png <- paste(wpath,'RMAWGENplotAplha_plot/spatial_XXX-lag_autocorrelation_tmin_coupled_unseas.png',sep='/')
	...
	title <- "XXX-lag spatial Autocorrelation: daily maximum temperature anom."
	png <- paste(wpath,'RMAWGENplotAplha_plot/spatial_XXX-lag_autocorrelation_tmax_coupled_unseas.png',sep='/')
...
png <- paste(wpath,'RMAWGENplotAplha_plot/spatial_autocrosscorrelation_tmax_coupled_lags.png',sep='/')
...
png <- paste(wpath,'RMAWGENplotAplha_plot/spatial_autocrosscorrelation_tmin_coupled_lags.png',sep='/')
