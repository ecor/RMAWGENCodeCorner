...
pdf <- "/Users/ecor/R-packages/RMAWGENCodeCorner/script_for_plotting/plot/zz_temperature_gaussianization.pdf"

pdf(pdf)
plot_sample(x=TEMPERATURE_MIN$T0090,sample="monthly",
origin="1958-1-1",axes=FALSE,
xlab="Tn [degC]",ylab="x",abline=NULL,col=col,legend_position = "topleft")
###plot_sample(x=TEMPERATURE_MIN\$T0090,sample="monthly",\\ %origin="1958-1-1",axes=FALSE,xlab="Tn [degC]",ylab="x")\\
dev.off()



pdf <- "/Users/ecor/R-packages/RMAWGENCodeCorner/script_for_plotting/plot/zz_precipitation_gaussianization.pdf"
pdf(pdf)
plot_sample(x=PRECIPITATION$T0090,sample="monthly",
origin="1958-1-1",axes=FALSE,xlab="Prec [mm]",
ylab="x",abline=NULL,valmin=0.5,step=0,col=col,legend_position = "bottomright")
