...
rdaname <-  'data/results_coupled_temperature_generator_P06.rda' ## from RMAWGENCodeCorner data
...
## save the plot here!!! 
png <- paste(wpath,'RMAWGENplotAplha_plot/cor_prec_temp.png',sep='/')
...
for (it in stations) { 
	...
	png_tmin <- paste(wpath,'RMAWGENplotAplha_plot/boxplot_wetdry_tmin_STATION.png',sep='/')
	png_tmax <- paste(wpath,'RMAWGENplotAplha_plot/boxplot_wetdry_tmax_STATION.png',sep='/')
	png_dt <- paste(wpath,'RMAWGENplotAplha_plot/boxplot_wetdry_dt_STATION.png',sep='/')
